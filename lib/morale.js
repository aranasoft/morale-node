...
Morale.prototype.getTickets = function(projectId, callback) {
  console.assert(typeof projectId === 'number' && projectId > 0, 'FAIL: INVALID PROJECTID');
  console.assert(typeof callback === 'function', 'FAIL: INVALID CALLBACK');
  this._makeRequest('/api/v1/projects/' + projectId + '/tickets', 'GET', callback);
  return this;
};
...
//  console.assert(typeof ticketIdentifier === 'number' && ticketIdentifier > 0, 'FAIL: INVALID TICKETID');
  console.assert(typeof callback === 'function', 'FAIL: INVALID CALLBACK');
  this._makeRequest('/api/v1/projects/' + projectId + '/tickets/' + ticketIdentifier, 'GET', callback);
  return this;
};
...
Morale.prototype.addTicket = function(ticket, callback) {
  ...
  return this.runTicketCommand(ticket.project_id, this._buildTicketCommand(ticket), callback);
};
...
Morale.prototype.updateTicket = function(ticket, callback) {
  ...
  var command = util.format("#%d: %s", ticket.identifier, this._buildTicketCommand(ticket));
  return this.runTicketCommand(projectId, command, callback);
};

Morale.prototype._buildTicketCommand = function(ticket) {
  console.assert(typeof ticket === 'object', 'FAIL: INVALID TICKET');
...
Morale.prototype.runTicketCommand = function(projectId, command, callback) {
  ...
  this._makeRequest('/api/v1/projects/' + projectId + '/tickets', 'POST', commandJson, callback);
  return this;
};
