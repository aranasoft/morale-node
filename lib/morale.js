...
var _makeAuthenticatedRequest = function(reqPath, reqMethod, reqData, callback) {
  ...
  _makeRequest.call(this, requestOptions, reqData, callback);
};

var _makeRequest = function(reqOptions, reqData, callback) {
  if (typeof reqData === 'function') {
    callback = reqData;
    reqData = undefined;
  }
  ...
  reqOptions.host = this.options.subdomain + ".teammorale.com";
  reqOptions.headers = {
      'Accept': '*/*',
      'Connection': 'close',
...
Morale.prototype.getProjects = function(callback) {
  console.assert(typeof callback === 'function', 'FAIL: INVALID CALLBACK');
  _makeAuthenticatedRequest.call(this, '/api/v1/projects', 'GET', callback);
  return this;
};
...
Morale.prototype.getProject = function(projectId, callback) {
  ...
  console.assert(typeof callback === 'function', 'FAIL: INVALID CALLBACK');
  _makeAuthenticatedRequest.call(this, '/api/v1/projects/' + projectId, 'GET', callback);
  return this;
};
...
Morale.prototype.addProject = function(project, callback) {
  ...
  _makeAuthenticatedRequest.call(this, '/api/v1/projects', 'POST', projectRequestData, callback);
  return this;
};
...
Morale.prototype.updateProject = function(project, callback) {
  ...
  _makeAuthenticatedRequest.call(this, '/api/v1/projects/' + project.id, 'PUT', projectRequestData, callback);
  return this;
};
...
Morale.prototype.deleteProject = function(projectId, callback) {
  console.assert(typeof projectId === 'number' && projectId > 0, 'FAIL: INVALID PROJECTID');
  console.assert(typeof callback === 'function', 'FAIL: INVALID CALLBACK');
  _makeAuthenticatedRequest.call(this, '/api/v1/projects/' + projectId, 'DELETE', callback);
  return this;
};
...
Morale.prototype.getTickets = function(projectId, callback) {
  console.assert(typeof projectId === 'number' && projectId > 0, 'FAIL: INVALID PROJECTID');
  console.assert(typeof callback === 'function', 'FAIL: INVALID CALLBACK');
  _makeAuthenticatedRequest.call(this, '/api/v1/projects/' + projectId + '/tickets', 'GET', callback);
  return this;
};
...
Morale.prototype.getTicket = function(projectId, ticketIdentifier, callback) {
  ...
  console.assert(typeof callback === 'function', 'FAIL: INVALID CALLBACK');
  _makeAuthenticatedRequest.call(this, '/api/v1/projects/' + projectId + '/tickets/' + ticketIdentifier, 'GET', callback);
  return this;
};
...
Morale.prototype.runTicketCommand = function(projectId, command, callback) {
  ...
  _makeAuthenticatedRequest.call(this, '/api/v1/projects/' + projectId + '/tickets', 'POST', commandJson, callback);
  return this;
};
